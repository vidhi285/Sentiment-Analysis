# ============================================================
# SENTIMENT ANALYSIS USING SGD CLASSIFIER (HINGE LOSS)
# TF-IDF + MONGODB
# ============================================================
...
plt.title("Confusion Matrix - SGD Hinge Loss")
...
joblib.dump(model, "sgd_svm_model.pkl")

joblib.dump(vectorizer, "sgd_tfidf_vectorizer.pkl")
...
print("\nSGD Hinge Loss Sentiment Analysis Completed Successfully")